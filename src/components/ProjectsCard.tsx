...
interface ProjectCardProps {
  value: {
    ...
    description: string;
    tags: string[];
    link?: string; // Made optional to safely support data variance
  };
  num: number;
}

const ProjectCards: React.FC<ProjectCardProps> = ({ value, num }) => {
  // Safe execution assignment ensures href never receives undefined
  const projectLink = value.link && value.link.trim() !== "" ? value.link : "#";
